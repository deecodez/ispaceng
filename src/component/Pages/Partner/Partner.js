    ...
    <div className='pr-10 p-bg'>
     <section id='home' className='flex md:flex-row flex-col p-20 sec-h sm:px-20 px-6'>
      <div className='flex-1 flex items-start flex-col xl:px-0 sm:px-16 px-6'>
        ...
        <div className='mt-10'>
            <img src='/Img/Img/Frame1.png' alt="partner" className='mt-1 w-[100%] '/>
        </div>
               ...
               <div>
                ...
                <div>
                    ...
                    <p className='font-poppins ss:text-[72px]'>
                       ...
                       doors to potential business collaborations.
                    </p>    
                </div>
            </div>
               ...
               <div>
                ...
                <div>
                    ...
                    <p className='font-poppins ss:text-[72px]'>
                       ...
                       clients, enhancing your reputation as a trusted marketing expert.
                    </p>    
                </div>
            </div>
               ...
               <div>
                ...
                <div>
                    ...
                    <p className='font-poppins ss:text-[72px]'>
                        ...
                        enhance your own standing in the eyes of your clients.
                    </p>    
                </div>
            </div>
        </div>
